...
git log --oneline            Información de los commits resumido
git status                  Información del estado
git add "archivo.x"              Agrega un archivo en especifico
...
git commit --amend          Modifica en la consola
